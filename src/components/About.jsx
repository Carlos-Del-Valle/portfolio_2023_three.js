  ...
  return (
    <Tilt className="xs:w-[250px] w-full">
      <motion.div
        ...
        className="w-full white-red-gradient p-[1px] rounded-[20px]"
      >
        <div
          options={{
            max: 45,
          ...
          className={`${styles.backgroundColourTwo} rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col`}
        >
